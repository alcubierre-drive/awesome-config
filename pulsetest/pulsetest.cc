...
#define MUTE "M"
#define PULSEAUDIO_VOLUME_LOGFILE "/home/lennart/.cache/pa_volume.log"
...
private:
            ...
            int eol, void *userdata)
    {
        if (i)
        {
            ...
            FILE * pa_outfile = fopen(PULSEAUDIO_VOLUME_LOGFILE, "w");
            fprintf(pa_outfile, "%.0f%%%s\n", volume * 100.0f, i->mute ? MUTE : "");
            fclose(pa_outfile);
        }
    }
